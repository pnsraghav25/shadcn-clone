...
type ColorTheme = 'Orange' | 'Blue' | 'Green' | 'Rose' | 'Zinc' | 'Violet' | 'Yellow' | 'Red';
...
export const ThemeProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
    ...
    const [radii, setRadii] = useState<string>('0.5')


    useEffect(() =>{
        document.getElementById('showcase')?.style.setProperty("--radius", radii+ 'rem');
        console.log(radii);
    ...
    return (
        <ThemeContext.Provider value={{ theme, colorTheme,radii, setTheme, setColorTheme , setRadii }}>
            {children}
